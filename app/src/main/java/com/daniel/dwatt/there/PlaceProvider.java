...
public class PlaceProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.daniel.dwatt.there.PlaceProvider";
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (uriMatcher.match(uri)) {
            case SEARCH:
                ...
                mCursor = new MatrixCursor(new String[]{"description", "lat", "lng", "locality"});

                // Create a parser object to searchParse places in JSON format
                parser = new PlaceJSONParser();

                // Create a parser object to searchParse place details in JSON format
                ...
                try {
                    ...
                    for (int i = 0; i < list.size(); i++) {
                        ...
                        detailsList = detailsParser.searchParse(new JSONObject(jsonPlaceDetails));
            ...
            case SUGGESTIONS:
                ...
                mCursor = new MatrixCursor(new String[]{"_id", SearchManager.SUGGEST_COLUMN_TEXT_1, SearchManager.SUGGEST_COLUMN_INTENT_EXTRA_DATA,"locality"});

                // Creating a parser object to searchParse places in JSON format
                parser = new PlaceJSONParser();
            ...
            case DETAILS:
                // Defining a cursor object with columns description, lat, lng, and locality
                mCursor = new MatrixCursor(new String[]{"description", "lat", "lng", "locality"});
                ...
                for (int j = 0; j < detailsList.size(); j++) {
                    ...
                    mCursor.addRow(new String[]{hMapDetails.get("formatted_address"), hMapDetails.get("lat"),
                            hMapDetails.get("lng"), hMapDetails.get("locality")});
